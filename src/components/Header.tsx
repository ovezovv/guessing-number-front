  ...
  return (
    <div className="w-full flex flex-row justify-between">
      <div className="w-full bg-gradient-to-r from-dark to-secondary rounded-lg p-2 border border-gray-700 flex">
        🎖
        <p className="w-full text-white-300 text-center font-mono">{user.points}</p>
      </div>
      <div className="w-full bg-gradient-to-r from-dark to-secondary rounded-lg p-2 border border-gray-700 mx-4 flex">
        👨‍💻
        <p className="w-full text-white-300 text-center font-mono">{user.username}</p>
      </div>
      <div className="w-full bg-gradient-to-r from-dark to-secondary rounded-lg p-2 border border-gray-700 flex">
        🕔
        <p className="w-full text-white-300 text-center font-mono">{currentTime.toLocaleTimeString()}</p>
      </div>
    </div>
  )
}
